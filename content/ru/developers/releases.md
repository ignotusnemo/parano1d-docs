...
хэш-кода листьев матриц должны совпадать с `pins.env`.
...
релиза, точную ревизию, успешно прошедшую Platform CI, и корректный хэш-код
пакета.
...
хэш-код пакета матриц, создаёт единый `SHA256SUMS`, загружает его и только после
...
7. сохраните журналы сборки и точный хэш-код пакета вместе с данными релиза.
