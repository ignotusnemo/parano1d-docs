...
AVX2, VPCLMULQDQ и AVX-512 выбираются автоматически. Скалярная эталонная
реализация в штатной ноде не используется.
...
NAT перенаправьте TCP `9400` на ноду. Синхронизация работает и при наличии только
